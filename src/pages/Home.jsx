    ...
    <>
      ...
      <div className=" py-6 px-4">
        <div className="max-w-2xl mx-auto text-left">
          ...
          <p className="text-lg text-gray-700 mb-8">
          With the explosive growth of social media—such as image-centric posts, short-form videos, and memes—understanding and capturing user engagement has become more important than ever. Accurate and generalizable prediction models are essential for empowering content creators, marketers, and platform designers to optimize their strategies and better connect with audiences.<br />
          <strong>SMP Challenge</strong> is an annual competition that offers a unique opportunity for researchers, engineers, and practitioners to tackle cutting-edge problems and explore novel artificial intelligence techniques for social multimedia. We welcome innovative solutions and outstanding teams that aim to push the boundaries of modeling social media dynamics—ultimately contributing to advancements that can enhance both user experiences and business applications in real-world social ecosystems.
